	...
	return (
		...
		<div className="politica-privacidad-container">
			...
			<p>
				...
				Vristok usa y protege la información que es proporcionada por sus
				...
				ser identificado, lo hacemos asegurando que sólo se empleará de acuerdo con
				los términos de este documento. Sin embargo esta Política de Privacidad
				puede cambiar con el tiempo o ser actualizada por lo que le recomendamos y
				enfatizamos revisar continuamente esta página para asegurarse que está de
			...
			<p>
				...
				ser requerida información específica para procesar algún pedido o realizar
			...
			<p>
				...
				dirección que usted proporcione y podrán ser cancelados en cualquier
				momento.
			</p>
			<br/>
			<p>
				Vristok está altamente comprometido para cumplir con el compromiso de
			...
			<p>
				...
				tanto no somos responsables de los términos o privacidad
				ni de la protección de sus datos en esos otros sitios terceros. Dichos
				sitios están sujetos a sus propias políticas de privacidad por lo cual es
			...
			<p>
				...
				vez que se le solicite rellenar un formulario, como el de alta de usuario,
				puede marcar o desmarcar la opción de recibir información por correo
				electrónico. &nbsp;En caso de que haya marcado la opción de recibir nuestro
			...
			<br/>
			<p>
				Vristok Se reserva el derecho de cambiar los términos de la presente
